...
if __name__ == "__main__":
    ...
    X_train_n, X_test_n, y_train_n, _ = dataset_norm.split_data() #fixed norm
    ...
    dataset_robust.plot_all_features_before_after_scaling(X_train_r, X_train_robust, scale_type="Robust Scaling")
